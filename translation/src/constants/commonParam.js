...
export const entryAllCols = [
  ...
  {
    label: "中文字符上限",
    value: "maxChineseLength",
    index: 31,
    visible: false,
  },
  {
    label: "外文字符上限",
    value: "foreignMaxLength",
    index: 32,
    visible: false,
  },
  {
...
export const termAuditAllCols = [
  ...
  { label: "目标语种", value: "target_lang", index: 4, visible: false },
  { label: "任务名称", value: "task_name", index: 5, visible: false },
  { label: "产品名称", value: "product_name", index: 6, visible: false },
  { label: "部门所属", value: "department", index: 7, visible: false },
  { label: "置信度", value: "confidence", index: 8, visible: true },
  { label: "参考术语", value: "similar_terms", index: 9, visible: true },
  ...
  { label: "上下文", value: "context", index: 16, visible: false },
  { label: "是否新术语", value: "is_new_term", index: 17, visible: false },
  { label: "来源类型", value: "source_type", index: 18, visible: false },
  {
    label: "操作",
    value: "action",
    index: 100,
...
export const termAuditPresets = {
  ...
  termAuditSelected: {
    ovrd: [
      ...
      { value: "entry_comment", visible: true },
...
export const wbAllCols = [
  ...
  { label: "abbr", value: "abbr", index: 23, visible: false },
