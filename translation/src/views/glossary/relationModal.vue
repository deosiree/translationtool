    ...
    data() {
        return{
            ...
            columns: [
                ...
                {title: '词条状态',dataIndex: 'entryState',align:'center',width:120,},
                ...
                {title: '翻译状态',dataIndex: 'translateState',align:'center',width:200,},
                {title: '分类名称',dataIndex: 'classify',align:'center',width:200,},
                {title: '产品名称',dataIndex: 'productName',align:'center',width:200,},
                {title: 'TAG',dataIndex: 'tag',align:'center',width:200,},
                {title: '版本',dataIndex: 'versionName',align:'center',width:200,},
                {title: '辞典名称',dataIndex: 'diName',align:'center',width:200,},
                {title: '词条来源',dataIndex: 'entrySource',align:'center',width:200,},
