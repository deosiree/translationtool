...
@Service
@Slf4j
public class EntryProductEntityServiceImpl extends ServiceImpl<EntryProductEntityMapper, EntryProductEntity>
    implements EntryProductEntityService{
    ...
    public List<EntryProductEntity> searchEntry(EntryReqEntity reqEntry, Integer pageIndex, Integer pageSize) {
        ...
        List<EntryProductEntity> entryProductEntities = entryProductEntityMapper.selectList(queryWrapper);
        return entryProductEntities;
    }
}
