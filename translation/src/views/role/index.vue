<template>
        ...
        <template #bodyCell="{ column, text, record }">
            ...
            <template v-else-if="column.dataIndex === 'operation'">
                ...
                <span v-else>
                    ...
                    <a-popconfirm title="确认删除?" @confirm="deleteRole(record.id)" v-if="authority.includes('deleteRoleInfo')">
    ...
    <AuthorityModel ref='authorityModel' :visible="modalVisible" :roleId="roleId" @changeShow="modelColse"/>
</template>
<script>
import {
  PlusOutlined,
...
import AuthorityModel from '@/views/role/authorityModel';
export default {
    components:{
        PlusOutlined,
        DeleteOutlined,
    ...
    methods: {
        ...
        getRoles(){
            ...
            // }
            queryRoleInfo(this.search).then((res) => {
