...
import relationModalVue from './relationModal.vue';
export default {
    components:{
        SearchBox,
        DataBox,
    ...
    data(){
        return{
            ...
            columns: [
                ...
                {title: '词条',dataIndex: 'entry',align:'center',width:150,fixed: 'left',resizable: true},
                {title: '翻译',dataIndex: 'translate',align:'center',width:150,resizable: true},
                {title: '翻译类型',dataIndex: 'type',align:'center',width:230,resizable: true},
                {title: '翻译状态',dataIndex: 'translateState',align:'center',width:180,resizable: true},
                {title: '翻译字符数',dataIndex: 'charLength',align:'center',width:150},
                {title: '可见范围',dataIndex: 'visualRange',align:'center',width:150},
                {title: '词条审核员',dataIndex: 'entryAuditor',align:'center',width:150},
                {title: '公开状态',dataIndex: 'publicState',align:'center',width:150},
                {title: '最大限制长度',dataIndex: 'maxLength',align:'center',width:150},
                {title: '审核意见',dataIndex: 'auditSuggest',align:'center',width:230,ellipsis: true,resizable: true},
    ...
    methods:{
        ...
        getSykEntry(){
            ...
            getSykEntry(params,this.search).then((res) => {
        ...
        save(id){
            updateSykEntry([this.editableData[id]]).then((res) => {
