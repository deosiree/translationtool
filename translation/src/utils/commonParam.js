...
export default {
  ...
  checkboxList: [
    ...
    { label: '英文释义', value: 'englishInterpretation', index: 10 },
    { label: "英文翻译", value: "english", index: 11 },
    { label: '俄文释义', value: 'russianInterpretation', index: 12 },
    { label: "俄文翻译", value: "russian", index: 13 },
    { label: '西文释义', value: 'spanishInterpretation', index: 14 },
    { label: "西文翻译", value: "spanish", index: 15 },
    { label: '法文释义', value: 'frenchInterpretation', index: 16 },
    { label: "法文翻译", value: "french", index: 17 },
    { label: "一级分类", value: "classfy1", index: 18 },
    { label: "二级分类", value: "classfy2", index: 19 },
    { label: "词条来源", value: "entrySource", index: 20 },
    { label: "回写辞典", value: "diFileName", index: 21 },
    { label: "abbr", value: "abbr", index: 22 },
    { label: '外文字符上限', value: 'foreignMaxByte', index: 23 },
