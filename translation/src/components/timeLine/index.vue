...
export default {
  ...
  mounted() {
    ...
    // console.log("进入流水线", this.currentTask);
    this.init();
  },
  ...
  methods: {
    init() {
      ...
      if (
        this.task.translationAuditor != "" &&
        this.task.translationAuditor != null
      ) {
        let item = {
          userType: "翻译审核员",
