            ...
            <a-row :gutter="24">
              <a-col :span="12">
                <a-form-item label="配置文件" name="config" :rules="[{ required: true, message: '请选择配置文件!' }]">
                  <a-select v-model:value="activeConfigModel.config" v-model:searchValue="activeSearchConfigValue"
                    mode="multiple" :max-tag-count="3" allowClear placeholder="请选择配置文件"
