    ...
    >
        <template #bodyCell="{ column, text, record }">
            ...
            <template v-else-if="column.dataIndex === 'operation'">
                ...
                <span v-else>
                    <a-button type="primary" ghost size="small" v-if="authority.includes('updateLabel')"
...
export default {
    ...
    methods: {
        ...
        getAuthority(){
            ...
            // 权限中含有 编辑  删除  表格展示操作栏
            if(this.authority.includes('updateLabel') || this.authority.includes('deleteLabel')){
        ...
        //获取用户列表
        getLabelList(){
            queryLabel(this.search,this.pagination.current,this.pagination.pageSize).then((res) => {
        ...
        save(id){
            ...
            if(this.editableData[id].labelName === '' || this.editableData[id].labelName === null){
        ...
        handleAdd(){
            ...
            // 滚动到最底部
            this.$nextTick(()=>{
                let container = this.$refs.labelTable.$el.querySelector('.ant-table-body')
