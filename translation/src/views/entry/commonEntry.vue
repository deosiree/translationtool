        ...
        <DataBox :title="tableTitle" :height="dataHeight" :showOperate="true">
            <template v-slot:operate>
                <div ref="button" v-if="admin" style="margin-bottom:8px;display:flex;gap:8px">
                    <a-button type="primary" size="small" @click="deletePublicEntry"><template #icon><DeleteOutlined /></template>删除</a-button>
    ...
    data() {
        return{
            ...
            columns: [
                ...
                {title: '翻译语言',dataIndex: 'type',align:'center',width:180,resizable: true},
                {title: '唯一属性',dataIndex: 'unique',align:'center',width:180,resizable: true},
                {title: '备注',dataIndex: 'remark',align:'center',width:150,resizable: true},
